...
static uint16_t load_LuigiBig(GBC_Graphics *gbc_graphics, uint8_t vram_bank, uint8_t vram_start_offset, uint8_t palette_num, uint8_t *num_sprites, const uint8_t **sprite_data) {
    ...
    GBC_Graphics_set_sprite_palette_array(gbc_graphics, palette_num, LUIGIBIG_PALETTES[0]);
...
static uint16_t load_LuigiFire(GBC_Graphics *gbc_graphics, uint8_t vram_bank, uint8_t vram_start_offset, uint8_t palette_num, uint8_t *num_sprites, const uint8_t **sprite_data) {
    ...
    GBC_Graphics_set_sprite_palette_array(gbc_graphics, palette_num, LUIGIFIRE_PALETTES[0]);
...
static uint16_t load_LuigiSmall(GBC_Graphics *gbc_graphics, uint8_t vram_bank, uint8_t vram_start_offset, uint8_t palette_num, uint8_t *num_sprites, const uint8_t **sprite_data) {
    ...
    GBC_Graphics_set_sprite_palette_array(gbc_graphics, palette_num, LUIGISMALL_PALETTES[0]);
...
static uint16_t load_MarioBig(GBC_Graphics *gbc_graphics, uint8_t vram_bank, uint8_t vram_start_offset, uint8_t palette_num, uint8_t *num_sprites, const uint8_t **sprite_data) {
    ...
    GBC_Graphics_set_sprite_palette_array(gbc_graphics, palette_num, MARIOBIG_PALETTES[0]);
...
static uint16_t load_MarioFire(GBC_Graphics *gbc_graphics, uint8_t vram_bank, uint8_t vram_start_offset, uint8_t palette_num, uint8_t *num_sprites, const uint8_t **sprite_data) {
    ...
    GBC_Graphics_set_sprite_palette_array(gbc_graphics, palette_num, MARIOFIRE_PALETTES[0]);
...
static uint16_t load_MarioSmall(GBC_Graphics *gbc_graphics, uint8_t vram_bank, uint8_t vram_start_offset, uint8_t palette_num, uint8_t *num_sprites, const uint8_t **sprite_data) {
    ...
    GBC_Graphics_set_sprite_palette_array(gbc_graphics, palette_num, MARIOSMALL_PALETTES[0]);
...
static uint16_t load_MarioWeird(GBC_Graphics *gbc_graphics, uint8_t vram_bank, uint8_t vram_start_offset, uint8_t palette_num, uint8_t *num_sprites, const uint8_t **sprite_data) {
    ...
    GBC_Graphics_set_sprite_palette_array(gbc_graphics, palette_num, MARIOWEIRD_PALETTES[0]);
...
uint16_t (*LOAD_SPRITE_GROUP[7])(GBC_Graphics *gbc_graphics, uint8_t vram_bank, uint8_t vram_start_offset, uint8_t palette_num, uint8_t *num_sprites, const uint8_t **sprite_data) = {
    load_LuigiBig,
    load_LuigiFire,
    load_LuigiSmall,
    load_MarioBig,
